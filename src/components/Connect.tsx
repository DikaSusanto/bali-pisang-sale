  ...
  return (
    ...
    >
      <motion.div variants={itemVariant} className="text-center md:text-left">
        <span className="text-primary font-medium text-lg">Interested?</span>
      ...
      <motion.div variants={itemVariant}>
        <Link
          href="/order"
          className="bg-primary hover:bg-yellow-800 text-white px-5 py-2.5 rounded-lg transition-colors duration-200 mt-4 md:mt-0"
        >
          Order
        </Link>
      </motion.div>
