...
const translations = {
  en: {
    ...
    'howItWorks.step4.detail2': 'Tracking number provided',
    ...
    'howItWorks.faq4.answer': 'Yes! You can modify your order before paying. Once you receive the payment link, contact us if you need changes.',
  ...
  id: {
    ...
    'howItWorks.step4.detail2': 'Nomor pelacakan disediakan',
    ...
    'howItWorks.faq1.answer': 'Kami ingin mengkonfirmasi ketersediaan produk dan memberikan biaya pengiriman yang akurat terlebih dahulu. Ini memastikan transparansi dan mencegah kejutan.',
    ...
    'howItWorks.faq4.answer': 'Ya! Anda dapat memodifikasi pesanan sebelum membayar. Setelah Anda menerima link pembayaran, hubungi kami jika Anda perlu perubahan.',
